 ...
 * @param spacing The spacing between adjacent rows of images
...
QImage combineImages(const QList<QImage> &images, const QColor &bgnd, int spacing = 0)
{
    int width = 0;
    int height = 0;
    const double devicePixelRatio = images.constFirst().devicePixelRatio();
    ...
    QImage combinedImage(width * devicePixelRatio, height * devicePixelRatio, images.constFirst().format());
